...
<a href="https://ai-human-game.chanmeng-dev.workers.dev/">
  <img src="docs/showcase/hero.webp" alt="AI vs Human Guessing Game landing page with pixel-art robot-vs-human logo, Start Game button, and category overview on a dark navy background" width="100%">
</a>

![Demo: navigating from the landing page to category selection, starting a Text round, and making an AI-or-Human guess](docs/showcase/demo.gif)
...
|---|---|
| <img src="docs/showcase/category.webp" alt="Category selection page showing Text (Recommended), Images, Audio and Videos options" width="520"> | <img src="docs/showcase/mobile-hero.webp" alt="Mobile view of the landing page with responsive pixel-art layout" width="260"> |
